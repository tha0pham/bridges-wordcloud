...
/***
 * Credits: https://github.com/harryaskham/Twitter-L-LDA/blob/master/util/Stemmer.java
 */
public class PorterStemmer implements Stemmer {
   ...
   */
   ...
   /* step3() maps double suffices to single ones. so -ization ( = -ize plus
     ...
     * the input.  You can retrieve the result with getResultLength()/getResultBuffer()
     * or toString().
     */
    public void stem() {
        k = i - 1;
